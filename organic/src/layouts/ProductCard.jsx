...
const ProductCard = ({ image, title, price, oldPrice, discount, status }) => {
    return (
        <div className='bg-white p-4 rounded-lg shadow hover:shadow-lg transition relative overflow-hidden'>
            ...
            {discount && <div className='bg-red-600 absolute top-2 left-2 text-white text-xs font-semibold px-2 py-1 rounded'>
                -{discount}%</div>}
            ...
            {status === 'soldout' ?
                ...
                :
                <button className='mt-4 w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded text-sm
                font-medium transition '>Shop Now</button>
